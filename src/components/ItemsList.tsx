        ...
        <>
            {Object.keys(vault).map((letter) => (
                <div key={letter} className='relative'>
                    <div className='sticky top-0 z-10 border-t border-b border-gray-200 bg-gray-100 px-6 py-1 text-sm font-medium text-gray-500 dark:border-gray-700 dark:bg-gray-800'>
                        <h3>{letter}</h3>
                    </div>
                    <ul role='list' className='relative z-0 divide-y divide-gray-200 dark:divide-gray-700'>
                        ...
                        {vault[letter].map((item) => (
                            <li key={item.id} className='bg-gray-50 dark:bg-gray-900'>
                                <div className='relative flex items-center space-x-3 px-6 py-5 focus-within:ring-2 focus-within:ring-inset focus-within:ring-primary-500 hover:bg-primary-50 dark:hover:bg-gray-800'>
                                    <div className='group flex-shrink-0 rounded-lg'>
                                        ...
                                        <span className='inline-flex h-10 w-20 items-center justify-center rounded-lg bg-gradient-to-r from-cyan-500 to-blue-500 transition delay-150 duration-300 ease-in-out group-hover:-translate-y-1 group-hover:scale-110'>
                                            <span className='font-mono text-sm font-bold leading-none tracking-tighter text-white'>
                                                {faker.random.numeric(3)} {faker.random.numeric(3)}
                                            </span>
                                        </span>
                                    </div>
